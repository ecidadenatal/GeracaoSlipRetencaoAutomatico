...
$sSqlDados = "select orcorgao.o40_orgao              as orgao,
		        ...
		        from slip 
		             ...
		             inner join empagemovconta              on empagemovconta.e98_codmov              = retencaoempagemov.e27_empagemov
...
if ($iQtdRegistros == "0") {
  ...
  $sMsgErro = "Nуo foi possэvel localizar ou nуo existem slips gerados para as retenчѕes";
...
$head1  = "RELATгRIO DE SLIPS GERADOS";
...
function imprimirDadosOrdemPagamento($oPdf, $oDados) {
  ...
  $oPdf->setfont('arial','b',6);
  $oPdf->cell(40, 4, "Orgуo/Unidade",             "T", 0, "L", 0);
  ...
  $oPdf->cell(45,  4, "Retenчуo",               1,  0, "L", 1);
  $oPdf->cell(12,  4, "Slip",                   1,  0, "C", 1);
  $oPdf->cell(70,  4, "Credor",                 1,  0, "L", 1);
  $oPdf->cell(60,  4, "Credor dados bancсrios", 1,  0, "L", 1);
